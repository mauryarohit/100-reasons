...
`;u(document.querySelector("#counter"));const s=[{src:"/public/vite.svg",caption:"Vite Logo"},{src:"/src/javascript.svg",caption:"JavaScript Logo"},{src:"/public/another-image.svg",caption:"Another Image"}],g=document.getElementById("background-image"),p=document.getElementById("caption"),m=document.getElementById("refresh-button");function a(){const c=Math.floor(Math.random()*s.length),o=s[c];g.src=o.src,p.textContent=o.caption}m.addEventListener("click",a);a();
