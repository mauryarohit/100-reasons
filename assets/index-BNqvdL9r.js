...
`;const i=[{src:"/saree.jpg",caption:"You look absolutely stunning in saree 😍"},{src:"/smile.JPG",caption:"You have a wonderful smile 😊"}],u=document.getElementById("background-image"),a=document.getElementById("caption"),l=document.getElementById("refresh-button");function s(){const n=Math.floor(Math.random()*i.length),o=i[n];u.src=o.src,a.textContent=o.caption}l.addEventListener("click",s);s();
